      ...
      <main className="mx-auto max-w-2xl px-6 py-24">
        ...
        <div className="mt-10 space-y-4">
          <a
            ...
            className="flex items-center gap-4 rounded-portfolio-xl border border-p-outline-var bg-p-surface px-6 py-4 transition-shadow hover:shadow-md"
          >
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-portfolio-lg bg-p-secondary/10">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-p-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          >
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-portfolio-lg bg-p-secondary/10">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-p-secondary" fill="currentColor" viewBox="0 0 24 24">
